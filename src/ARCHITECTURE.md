...
=>Le dossier models comprend trois interfaces (olympic.ts, participation.ts et statistics.ts).
...
=>Le dossier components comprend:
    ...
    => un composant statistics. Il est réutilisable. Il gère la construction et l'affichage du titre des pages et une liste d'indicateurs/de statistiques comportant un label et une valeur.
...
=>Le dossier pages comporte trois composants: 
    ...
    =>country-detail-page: ce composant parent contient un composant enfant:
        =>medal-chart
